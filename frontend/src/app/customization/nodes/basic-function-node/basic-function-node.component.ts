...
@Component({
  templateUrl: "./basic-function-node.component.html",
  styleUrls: ["./basic-function-node.component.sass"],
  host: {
    "data-testid": "node"
  }
})
export class BasicFunctionNodeComponent implements OnChanges {
